/**
 * Canonical serialization of SimState.
 *
 ...
 *   5  player.slideTicks (slide move)
 */
...
// id, pos, vel, yaw, pitch, health, downTicks, crouching, grounded, coyote, jumpBuffer, slideTicks,
...
const PLAYER_BYTES =
  4 + 24 + 24 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 8 + 8 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4;
